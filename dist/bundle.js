...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (configObj) {
	  ...
	  return {
	    ...
	    drawHeatMapFromRemote: function drawHeatMapFromRemote() {
	      actions.drawHeatMapFromRemote(state);
	    }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.drawHeatMapFromRemote = drawHeatMapFromRemote;

	var _drawMap = __webpack_require__(3);

	var _drawMap2 = _interopRequireDefault(_drawMap);

	var _drawMapFromRemote = __webpack_require__(5);

	var _drawMapFromRemote2 = _interopRequireDefault(_drawMapFromRemote);

	var _pointQueuePoster = __webpack_require__(29);
	...
	function drawHeatMap(state, pointsBatch) {
	  stopRecording(state);
	  _drawMap2.default.drawByBatch(state.recordedPoints, pointsBatch);
	}

	function drawHeatMapFromRemote(state, pointsBatch) {
	  (0, _drawMapFromRemote2.default)(state.config);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function loadPointsAndDraw() {
	  ...
	  _axios2.default.get(_config.getPointsUrl, { params: getData }).then(function (response) {
	    if (response.data.points.length > 0) {
	      _drawMap2.default.draw(response.data.points);
