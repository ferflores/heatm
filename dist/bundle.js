	...
	exports.default = function (configObj) {
	  ...
	  return {
	    startRecording: function startRecording() {
	      actions.startRecording(state);
	    },
	    stopRecording: function stopRecording() {
	      actions.stopRecording(state);
	    },
	    startPostingPoints: function startPostingPoints() {
	      actions.startPostingPoints(state);
	    },
	    stopPostingPoints: function stopPostingPoints() {
	      actions.stopPostingPoints(state);
	    },
	    drawHeatMap: function drawHeatMap() {
	      actions.drawHeatMap(state);
	    }
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stopPostingPoints = stopPostingPoints;
	exports.drawHeatMap = drawHeatMap;

	var _drawMap = __webpack_require__(3);

	var _drawMap2 = _interopRequireDefault(_drawMap);

	var _pointQueuePoster = __webpack_require__(5);
	...
	function startPostingPoints(state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorInterpolation = __webpack_require__(4);
	...
	exports.default = function (points, pointsBatch) {
